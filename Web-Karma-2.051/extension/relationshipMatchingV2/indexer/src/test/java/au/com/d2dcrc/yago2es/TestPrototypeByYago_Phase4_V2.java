 ...
 */
public class TestPrototypeByYago_Phase4_V2 {
    ...
    public void TestPrototype () throws Exception {
        ...
        for (Graph usefulFrequentGraph_RT : usefulFrequentGraphs_RT) {
            ...
            for (Graph usefulFrequentGraph_non_RT : usefulFrequentGraphs_non_RT) {
                ...
                if (subgraphMatcher.compare(usefulFrequentGraph_RT, usefulFrequentGraph_non_RT)) {
...
//        }
        ...
        System.out.println(discriminativeFeatureSet.size() + " discriminative features are used.");
    }
}

...
public class ObjectOfPredicate {
     ...
     * **/
    public ObjectOfPredicate(String obj){
        ...
        if( (!Character.toString(obj.charAt(0)).equals("\"")) && !(Character.toString(obj.charAt(obj.length()-1)).equals("\"")) ){
            ...
            if(Util.verifyStr_beginwithN(str_after_underline)){

                setIsEntity(true);

                /**Segment the 'object' into different parts in terms of underline '_'**/
                List<String> strings = Util.segmentation(obj);
    ...
    public static void main(String args[]){
        ...
        ObjectOfPredicate objectOfPredicate = new ObjectOfPredicate("_:Bank1_2bf18aad8483f26446edae4ddc7b1264eefd1d05_N26");
    }

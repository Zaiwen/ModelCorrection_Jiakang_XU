...
CREATE TABLE conferences (
  ConfID integer NOT NULL default 0,
...
CREATE TABLE organizations (
  ...
  Belongsto integer default NULL,
  Homepage varchar(200) default NULL,
  PRIMARY KEY  (OrgID)
);

CREATE INDEX idx_organizations_Belongsto ON organizations(Belongsto);
...
CREATE TABLE papers (
  PaperID integer NOT NULL default 0,
  Title varchar(200) default NULL,
  Abstract text,
  URI varchar(200) default NULL,
  Year integer default NULL,
  Conference integer default NULL,
...
CREATE TABLE persons (
  PerID integer NOT NULL default 0,
  Type varchar(50) default NULL,
...
CREATE TABLE rel_paper_topic (
  ...
  RelationType integer default NULL,
  PRIMARY KEY  (PaperID,TopicID)  
);

CREATE INDEX idx_rel_paper_topic_TopicID ON rel_paper_topic(TopicID);
...
CREATE INDEX idx_rel_person_organization_OrganizationID ON rel_person_organization(OrganizationID);
...
CREATE INDEX idx_rel_person_paper_PaperID ON rel_person_paper(PaperID);
...
CREATE INDEX idx_rel_person_topic_TopicID ON rel_person_topic(TopicID);
-- 
...
CREATE INDEX idx_topics_TopicID ON topics(ParentID);

...
//			System.out.println("steiner nodes id ------ " + n.getId());
		...
		N.getTopKTrees(k);/**essentially computing Steiner trees. 7 June 2018.**/
...
//			System.out.println(f.toString());
	...
	public static void main(String[] args) throws Exception {
		...
		ServletContextParameterMap contextParameters = ContextParametersRegistry.getInstance().getContextParameters("/Users/fengz/karma");
		...
		String preloadedOntDir = "/Users/fengz/karma/preloaded-ontologies/";
...
//						logger.error("Error loading ontology: " + ontology.getAbsolutePath(), t);
		...
		System.out.println("there are " + trees.size() + " candidate trees! ");

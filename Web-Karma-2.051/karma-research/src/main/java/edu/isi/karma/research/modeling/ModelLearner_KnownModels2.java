...
//
//				/**create a new list for updated steiner nodes. 8 June 2018.**/
//				List<Node> updatedSteinerNodes = new LinkedList<Node>();
//
...
//				}
//
//				/**Get all of the column nodes in 'modelLearnerGraph'. 8 June 2018.**/
//                DirectedWeightedMultigraph<Node, DefaultLink> mergedGraph = modelLearner.graphBuilder.getGraph();
//
//                /**Get all the edge**/
//                Set<DefaultLink> allLinks = mergedGraph.edgeSet();
//
//                /**Convert each 'DefaultLink' to 'LabeledLink'**/
//                Iterator<DefaultLink> iterator = allLinks.iterator();
//                while (iterator.hasNext()) {
//
//                    DefaultLink defaultLink = iterator.next();
//                   // LabeledLink labeledLink;
//                    //System.out.println(defaultLink.getId());
//                }
//
//                /**Get all the vertices**/
//                Set<Node> allNodes = mergedGraph.vertexSet();
...
//
//
//                    /**If the node type is column node, print its column name**/
//                    if (nodeType.equals("ColumnNode")) {
//                        /**cast to Column Node**/
//                        ColumnNode columnNode = (ColumnNode)node;
//                        String columnName = columnNode.getColumnName();
//                        System.out.println(columnName);
//
//                        /**update Steiner nodes list. 8 June 2018.**/
//                        for (Node n : steinerNodes) {
//
//                            /**cast to column node**/
//                            ColumnNode columnNodeInNewDS = (ColumnNode)n;
//                            String columnNameInNewDS = columnNodeInNewDS.getColumnName();
//
//                            /**Compare 'columnNameInNewDS' with 'columnName'. If they are same, replace Steiner node. 8 June 2018.**/
//                            if (columnNameInNewDS.equals(columnName)) {
//
//                                updatedSteinerNodes.add(columnNode);
//
//                            }
//                        }
//
...
//                }
//
//                modelLearner.setSteinerNodes(updatedSteinerNodes);/**update Steiner nodes. 9 June 2018.**/
//

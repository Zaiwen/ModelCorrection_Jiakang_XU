...
public abstract class LabeledLink extends DefaultLink {
	...
	private CardinalityInfo startCardinality;//added on 18 Aug 2018. It should be only used in the CDM
	private CardinalityInfo targetCardinality;//added on 18 Aug 2018. It should be only used in the CDM
	...
	/**set cardinality in the starting point. revised on 22 Aug 2018.**/
	public void setCardinality(CardinalityInfo startCardinality, CardinalityInfo targetCardinality){
	    this.startCardinality = startCardinality;
	    this.targetCardinality=targetCardinality;
    }

    /**get cardinality in the starting point. 19 Aug 2018.**/
    public CardinalityInfo getStartCardinality() {
        return startCardinality;
    }

    /**get cardinality of the target point. 19 Aug 2018.**/
    public CardinalityInfo getTargetCardinality() {

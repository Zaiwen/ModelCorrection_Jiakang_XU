  ...
  <div class="modal-dialog">
  		<form class="bs-example bs-example-form" role="form">
			<div class="modal-content">
			     <div class="modal-header">
				      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				       <h4 class="modal-title">Save as JSON. Just test on 1 Feb 2018.</h4>
				  </div>
				  <div class="modal-body">
...
<!--Added on 28 Jan 2018.-->
<div class="modal fade" id="writeMappingToCDM" tabindex="-1">
	<div class="modal-dialog">
		<form class="bs-example bs-example-form" role="form">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title">Write mapping rules to CDM mapping repository</h4>
				</div>

				<div class="modal-body">
					<h4>Select Model:</h4>
					<div id="applyModelDialogColumns" style="max-height: 300px; overflow: auto;"></div><!--added on 3/2/2018-->
				</div> <!-- /.modal-body -->

				<div class="modal-body">
					Would you like to input a new name for data source?

						<div class="form-group">
							<label for="literal">Source Name:</label>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					<button type="submit" class="btn btn-primary" id="btnYes1">Yes, Write them to CDM</button>
				</div> <!-- /.modal-footer -->
			</div><!-- /.modal-content -->
		</form>
	</div><!-- /.modal-dialog -->
			...
			<div class="modal-content">
			     <div class="modal-header">
				  ...
				  <div class="modal-body">
					  ...
					  <!--<div id="applyModelDialogHeaders"></div>--><!--delete on 3/2/2018-->

...
public class RequestController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		logger.info("hi. just a test.");//added on 1 Feb 2018.
		...
		if (isUserInteraction) {
			...
			System.out.println("enter this branch (Branch 1)." + "The the commondId is: " + commandId);
			...
			System.out.println("enter this branch (Branch 2).");
			...
			System.out.println("enter this branch (Branch3).");
			...
			try {
				...
				System.out.println("the responseString is: " + responseString);

...
public abstract class SearchLatticeNode<NodeType, EdgeType>  implements
	...
	private boolean stopExtend = false;

	private boolean canonPruning = true;
...
//			Collection<HPEmbedding<NodeType, EdgeType>> embs);
	...
	public void extending(boolean flag){
		extending = flag;
	}

	public boolean stopExtend(){
		return stopExtend;
	}

	public void stopExtend(boolean flag){
		stopExtend = flag;
	}

	public boolean isCanonPruning(){
		return canonPruning;
	}

	public void setCanonPruning(boolean flag){
		canonPruning = flag;
	}

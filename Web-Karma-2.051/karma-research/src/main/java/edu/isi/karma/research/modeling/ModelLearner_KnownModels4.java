...
//        }
    ...
    public static List<SortableSemanticModel> getCandidateSemanticModels(int newSourceIndex, String outputPath) throws Exception {
...
//        File[] files = ff.listFiles();
//        for (File f : files) {
//            if (!f.getName().endsWith(".owl") && !f.getName().endsWith(".rdf")) {/**filter out ".DS_Store" file in the directory of 'preloaded-ontologies'**/

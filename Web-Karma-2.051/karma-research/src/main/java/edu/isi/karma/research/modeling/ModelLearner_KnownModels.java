...
//			System.out.println(source.getName());
	...
	public static void runResearchEvaluation() throws Exception {
		 ...
		 */
		ServletContextParameterMap contextParameters = ContextParametersRegistry.getInstance().registerByKarmaHome("/Users/fengz/karma/");
		contextParameters.setParameterValue(ContextParameter.USER_DIRECTORY_PATH, "/Users/fengz/karma/");
		contextParameters.setParameterValue(ContextParameter.USER_CONFIG_DIRECTORY, "/Users/fengz/karma/config");
		contextParameters.setParameterValue(ContextParameter.TRAINING_EXAMPLE_MAX_COUNT, "1000000");
		contextParameters.setParameterValue(ContextParameter.SEMTYPE_MODEL_DIRECTORY, "/Users/fengz/karma/semantic-type-files/");
		contextParameters.setParameterValue(ContextParameter.JSON_MODELS_DIR, "/Users/fengz/karma/models-json/");
		contextParameters.setParameterValue(ContextParameter.GRAPHVIZ_MODELS_DIR, "/Users/fengz/karma/models-graphviz/");
		contextParameters.setParameterValue(ContextParameter.USER_PYTHON_SCRIPTS_DIRECTORY, "/Users/fengz/karma/python/");
		contextParameters.setParameterValue(ContextParameter.EVALUATE_MRR, "/Users/fengz/karma/evaluate-mrr/");
...
//							resultFile.println(me.getPrecision() + "\t" + me.getRecall() + "\t" + elapsedTimeSec);
	...
	public static void runUkHackEvaluation() throws Exception {
		...
		String karmaHomeDir = "/Users/fengz/karma-uk-hack/";

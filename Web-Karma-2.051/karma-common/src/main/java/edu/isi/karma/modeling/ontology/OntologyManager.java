...
//	}
	...
	public HashSet<String> getObjectPropertiesWithOnlyRange(String rangeUri) {
		...
		/**detect if there is a direct link between source and target in the domain ontology. 3 June 2019**/
...
//		ServletContextParameterMap contextParameters = ContextParametersRegistry.getInstance().registerByKarmaHome("/Users/fengz/karma-rodi/");
//		contextParameters.setParameterValue(ContextParameter.USER_CONFIG_DIRECTORY, "/Users/fengz/karma-rodi/config");
//		OntologyManager ontManager = new OntologyManager(contextParameters.getId());
//		ontManager.doImport(new File("/Users/fengz/karma-rodi/preloaded-ontologies/schema.nt"), "UTF-8");

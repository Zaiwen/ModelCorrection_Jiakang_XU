...
//		}
	...
	public static void simpleTest() {
		...
		SemanticType st1 = new SemanticType("", null, new Label("http://erlangen-crm.org/current/E39_Actor"), "", false, Origin.User, 1.0);
		SemanticType st2 = new SemanticType("", null, new Label("http://erlangen-crm.org/current/E22_Man-Made_Object"), "", false, Origin.User, 1.0);
		SemanticType st3 = new SemanticType("", null, new Label("http://erlangen-crm.org/current/E21_Person"), "", false, Origin.User, 1.0);
		SemanticType st4 = new SemanticType("", null, new Label("http://erlangen-crm.org/current/E55_Type"), "", false, Origin.User, 1.0);
		SemanticType st5 = new SemanticType("", null, new Label("http://www.w3.org/2004/02/skos/core#Concept"), "", false, Origin.User, 1.0);
		types.add(st1); 
		types.add(st2);
		types.add(st3);
		types.add(st4);

...
//		},
	...
	//			func: publishServiceModel
				...
				name: "CDM Mapping Repository",
                func: writeToCDMMappingRepo
			},
				{
				name: "Raw JSON",
				func: saveAsJson
...
//
    //This function is added on 22 Jan 2018. Edited on 3 Feb 2018.
	function writeToCDMMappingRepo(event) {
	    console.log("Write mapping rules for " + worksheetTitle + " to CDM mapping repository");
	    hideDropdown();
	    WriteCDMDialog.getInstance(worksheetId).show();
        return false;
    }

	
	function saveAsJson() {
		console.log("Save as json. Monitored....1 Feb 2018.");
		hideDropdown();

...
public class Algorithm<NodeType, EdgeType> implements
	 ...
	 *
	 */
	private DFSCode<NodeType, EdgeType> initialNode;
	 ...
	 * @param initialNode
	 */
	public void setInitialNode(DFSCode<NodeType, EdgeType> initialNode) {
	 ...
	 * @return
	 */
	public DFSCode<NodeType, EdgeType> getInitialNode() {
		return initialNode;
	}
	...
	public Extender<NodeType, EdgeType> getExtender(int minFreq, Graph initGraph){
		// configure mining chain

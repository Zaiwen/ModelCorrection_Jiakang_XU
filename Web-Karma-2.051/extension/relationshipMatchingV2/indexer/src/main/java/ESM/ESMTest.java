...
public class ESMTest {
    ...
    public void setUpClass() {
        ...
        String s = "amod(BIO_Entity1-14/NNP, -Producing-15/JJ); nn(BIO_Entity1-14/NNP, Cells-17/NNS); nn(BIO_Entity1-14/NNP, BIO_Entity2-19/NNP); " +
                "nn(BIO_Entity1-14/NNP, BIO_Entity3-29/NNP); nn(BIO_Entity4-39/NNP, BIO_Entity1-14/NNP)";
        graph = createGraph(s);
        test = new ESM(subgraph, graph);
        b = test.isSubgraphIsomorphism();
        c = test.isGraphIsomorphism();
    ...
    public static DirectedGraph createGraph(){
        ...
        Vertex v0 = new Vertex(0, "DATA");
        v0.setLemma("3");
        v0.setGeneralizedPOS("NN");
        v0.setCompareForm("3 nn");
        graph.addVertex(v0);
        tokenToNode.put(String.valueOf(v0.getPos()), v0);

        Vertex v1 = new Vertex(1, "DATA");
        v1.setLemma("1");
        v1.setGeneralizedPOS("NN");
        v1.setCompareForm("1 nn");
        graph.addVertex(v1);
        tokenToNode.put(String.valueOf(v1.getPos()), v1);

        Vertex v2 = new Vertex(2, "DATA");
        v2.setLemma("2");
        v2.setGeneralizedPOS("NN");
        v2.setCompareForm("2 nn");
        graph.addVertex(v2);
        tokenToNode.put(String.valueOf(v2.getPos()), v2);

        Edge govToDep33 = new Edge(v0, "33", v1);
        graph.addEdge(govToDep33,v0,v1);

        Edge govToDep11 = new Edge(v2, "11", v1);
        graph.addEdge(govToDep11,v2,v1);

        Edge govToDep22 = new Edge(v2, "22", v0);
        graph.addEdge(govToDep22, v2, v0);
    ...
    /**create sub-graph**/
    public static DirectedGraph createSubGraph(){

        DirectedSparseGraph<Vertex,Edge> subGraph = new DirectedSparseGraph<Vertex,Edge>();

        Map<String, Vertex> tokenToNode = new HashMap<String, Vertex>();

        Vertex v0 = new Vertex(0, "SUB");
        v0.setLemma("1");
        v0.setGeneralizedPOS("NN");
        v0.setCompareForm("1 nn");
        subGraph.addVertex(v0);
        tokenToNode.put(String.valueOf(v0.getPos()), v0);

        Vertex v1 = new Vertex(1, "SUB");
        v1.setLemma("3");
        v1.setGeneralizedPOS("NN");
        v1.setCompareForm("3 nn");
        subGraph.addVertex(v1);
        tokenToNode.put(String.valueOf(v1.getPos()), v1);

        Vertex v2 = new Vertex(2, "SUB");
        v2.setLemma("2");
        v2.setGeneralizedPOS("NN");
        v2.setCompareForm("2 nn");
        ...
        Edge govToDep33 = new Edge(v1, "33", v0);
        subGraph.addEdge(govToDep33,v1,v0);

        Edge govToDep11 = new Edge(v2, "11", v0);
        subGraph.addEdge(govToDep11,v2,v0);
...
//     *
//     * */
//    public static DirectedGraph createSubGraph2(){
//
//        DirectedSparseGraph<Vertex,Edge> subGraph = new DirectedSparseGraph<Vertex,Edge>();
//
//        Map<String, Vertex> tokenToNode = new HashMap<String, Vertex>();
//
//        Vertex v0 = new Vertex(0 , "PATTERN");
//        v0.setLemma("U");
//        v0.setGeneralizedPOS("NN");
//        v0.setCompareForm("4 nn");
//        subGraph.addVertex(v0);
//        tokenToNode.put(String.valueOf(v0.getPos()), v0);
//
//
...
//        v1.setLemma("6");
//        v1.setGeneralizedPOS("NN");
//        v1.setCompareForm("6 nn");
//        subGraph.addVertex(v1);
//        tokenToNode.put("1", v1);
//
//        Vertex v2 = new Vertex();
//        v2.setLemma("5");
//        v2.setGeneralizedPOS("NN");
//        v2.setCompareForm("5 nn");
//        subGraph.addVertex(v2);
//        tokenToNode.put("2", v2);
//
//        Edge govToDep33 = new Edge(v1, "33", v0);
//        subGraph.addEdge(govToDep33,v0,v1);
//
//        Edge govToDep11 = new Edge(v2, "11", v0);
//        subGraph.addEdge(govToDep11,v0,v2);
//
//        return subGraph;
//    }
     ...
     */
    public static void isGraphIsmomorphismTest(){
        ...
        //String g1 = "nn(patients-7/NNS, hepatitis-5/NN); nn(patients-7/NNS, B-6/NN); prep_in(cytokines-3/NNS, patients-7/NNS); partmod(patients-7/NNS, treated-8/VBN); prep_with(treated-8/VBN, PROTEIN0-10/NN)";
        //String g1 = "prep_in(cytokines-3/NNS, patients-7/NNS)";
        //String g1 = "nn(patients-5/NN, hepatitis-7/NNS)";
        //String g2 = "nn(type-20/NN, Th1/Th2-11/NN); partmod(patients-7/VBN, treated-8/NNS); prep_in(cytokines-3/NNS, patients-7/NNS); nn(patients-7/NNS, B-6/NN); nn(patients-7/NNS, hepatitis-5/NN); nsubj(cytokines-3/NNS, type-20/NN); prep_with(treated-8/VBN, PROTEIN0-10/NN)";


        DirectedGraph<Vertex,Edge> graph1 = createSubGraph();
        DirectedGraph<Vertex,Edge> graph2 = createGraph();

        ESM esm  = new ESM(graph1, graph2); //graph1-subgraph; graph2-graph

        b = esm.isGraphIsomorphism();
        c = esm.isSubgraphIsomorphism();
     ...
     */
    public static void getSubgraphMatchingMatches() {

        //String g1 = "det(mutant-3/NN, this-2/DT); prep_in(reduced-40/VBN, mutant-3/NN); conj_and(mutant-3/NN, expression-5/NN); prep_in(reduced-40/VBN, expression-5/NN); det(gene-9/NN, the-7/DT); nn(gene-9/NN, PROTEIN2-8/NN); prep_of(expression-5/NN, gene-9/NN); poss(transcription-12/NN, whose-11/WP$); nsubj(depends-13/VBZ, transcription-12/NN); rcmod(gene-9/NN, depends-13/VBZ); det(PROTEIN0-16/NN, both-15/DT); prep_on(depends-13/VBZ, PROTEIN0-16/NN); dep(PROTEIN0-16/NN, PROTEIN0-18/DT); det(protein-24/NN, the-21/DT); amod(protein-24/NN, phosphorylated-22/JJ); nn(protein-24/NN, PROTEIN1-23/NN); conj_and(mutant-3/NN, protein-24/NN); prep_in(reduced-40/VBN, protein-24/NN); nsubjpass(reduced-40/VBN, Spo0A~P-26/NN); det(factor-31/NN, a-28/DT); amod(factor-31/NN, major-29/JJ); nn(factor-31/NN, transcription-30/NN); appos(Spo0A~P-26/NN, factor-31/NN); amod(stages-34/NNS, early-33/JJ); prep_during(factor-31/NN, stages-34/NNS); prep_of(stages-34/NNS, sporulation-36/NN); auxpass(reduced-40/VBN, was-38/VBD); advmod(reduced-40/VBN, greatly-39/RB); number(degrees-43/NNS, 43-42/CD); num(C-44/NN, degrees-43/NNS); prep_at(reduced-40/VBN, C-44/NN)";
        //String p1 = "prep_on(depend-1/VBZ, PROTEIN0-2/NN); rcmod(gnome-3/NN, depend-1/VBZ); prep_of(expression-4/NN, gnome-3/NN); nn(protein-7/NN, PROTEIN1-8/NN);  conj_and(mutant-3/NN, expression-4/NN); conj_and(mutant-3/NN, protein-7/NN)";
        DirectedGraph<Vertex,Edge> graph = createGraph();
        DirectedGraph<Vertex,Edge> pattern = createSubGraph();
        ESM esm = new ESM (pattern, graph);

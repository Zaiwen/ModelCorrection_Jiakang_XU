...
//			addOntologyPaths = Boolean.parseBoolean(modelingProperties.getProperty("add.ontology.paths", "true"));
			...
			if(addOntologyPathsStr != null)
				...
				addProperty("add.ontology.paths", "true");
			}
	...
	private Properties loadParams()
		...
		File file = new File(contextParameters.getParameterValue(ContextParameter.USER_CONFIG_DIRECTORY) + "modeling.properties");//remove "/" on 16 May 2018.
